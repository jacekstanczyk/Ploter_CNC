...
void ploter2D::szukajRozdzielczosc()
{
...
void ploter2D::pobierzXYZ(int * x, int * y, int * z)
{
	*x=polozenieFrezuX;
	*y=polozenieFrezuY;
	*z=polozenieFrezuZ;
...
void ploter2D::ustawKartezjanskieXYZ(int kartezjanskieMinX, int kartezjanskieMaxX, int kartezjanskieMinY, int kartezjanskieMaxY, int kartezjanskieMinZ, int kartezjanskieMaxZ)
{
...
double ploter2D::kat2radian(double kat)
{
	return ( ((2*pi)/360)*kat );
}
...
void ploter2D::rLiniaDo(int x, int y)
{
...
void ploter2D::rElipsa(int x, int y, int xR, int yR, int glebokosc, double poczatek, double koniec)
{
...
void ploter2D::elipsa(double x, double y, double xR, double yR, double poczatek, double koniec)
{
