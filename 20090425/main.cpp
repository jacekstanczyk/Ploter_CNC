...
for (;;)
{
	...
	switch (ktora)
	{
		...
		case 2:
			{
				przeliczPlikPLT("sterownikRedyOnlyDrills.plt");
				rysujPlikPLT("sterownikRedyOnlyDrills.plt");
			}
			break;
		case 1:
			{
				przeliczPlikPLT("sterownikRedy.plt");
				rysujPlikPLT("sterownikRedy.plt");
			}
			break;
		case 21:
			{
